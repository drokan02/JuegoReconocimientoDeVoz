...
public class Grabador{
    ...
    public ArrayList<Double> muestraDeAudio(File audio){
        try{
    ...
    public void filtrarMuesta(ArrayList<Double> m, double filtro){
            double a,b;
   ...
   //reduce la muestra hasta un minimo y un maximo donde no hay espacios vacios
    public ArrayList<Double> nuevaMuestra(double[] a,int min,int max){
        ArrayList<Double> res = new ArrayList<>();
